...
contract BlindBoxToken is Context,AccessControlEnumerable,ERC20Pausable,IERC20Intact {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    bytes32 public constant GOVERNOR_ROLE = keccak256("GOVERNOR_ROLE");

    event Minted(address indexed from, address indexed to, uint indexed amount);
    event Burned(address indexed from, uint indexed amount);

    constructor() ERC20("BlindBox", "BBOX") {
    ...
    /**
     * @dev Disable token transfers by always reverting the transfer function.
     */
    function transfer(address /*to*/, uint256 /*amount*/) public pure override(ERC20, IERC20) returns (bool) {
